...
import com.example.zhenghaozhang.findacat.petfinder.PetfinderResponse
...
class PetSearchManager(private val context: Context,private val zipcodeSearch:String){
    ...
    fun searchPets() {
        ...
        apiEndpoint.findPets("0b1452a0af588b352bf732936fa8219b", "json", "cat", Integer.parseInt(zipcodeSearch)).enqueue(object: Callback<PetfinderResponse> {
